#  tests for h5py-3.15.1-nompi_py311h0b2f468_101 (this is a generated file);
print('===== testing package: h5py-3.15.1-nompi_py311h0b2f468_101 =====');
...
print('===== h5py-3.15.1-nompi_py311h0b2f468_101 OK =====');
print("import: 'h5py'")
import h5py
